...
export type ExperienceHash = Record<string, Experience>;

export const EXPERIENCE_HASH_MAP: ExperienceHash = {
  'Connex AI': {
...
export const COMPANIES = Object.keys(EXPERIENCE_HASH_MAP);
